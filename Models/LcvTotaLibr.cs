...
{
    public partial class LcvTotaLibr
    {
        public LcvTotaLibr()
        {
            LcvTotaNore = new HashSet<LcvTotaNore>();
        }
        ...
        public decimal? OperVafi { get; set; }
        public decimal? OperIvac { get; set; }
        public decimal? MontIvac { get; set; }
        public decimal? FactProp { get; set; }
        public decimal? MontCrco { get; set; }
        ...
        public decimal? MontCrec { get; set; }
        ...
        public virtual ICollection<LcvTotaNore> LcvTotaNore { get; set; }
    }
}
