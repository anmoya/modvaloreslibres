...
{
    public partial class DteEncaDocu
    {
        public DteEncaDocu()
        {
            DteAcciDocu = new HashSet<DteAcciDocu>();
            DteArchAdju = new HashSet<DteArchAdju>();
            DteComiCarg = new HashSet<DteComiCarg>();
            DteDescReca = new HashSet<DteDescReca>();
            DteDetaAcec = new HashSet<DteDetaAcec>();
            DteDetaPrse = new HashSet<DteDetaPrse>();
            DteDocuLob = new HashSet<DteDocuLob>();
            DteDocuRefe = new HashSet<DteDocuRefe>();
            DteEnviPdf = new HashSet<DteEnviPdf>();
            DteSumaImom = new HashSet<DteSumaImom>();
            DteSumaImpu = new HashSet<DteSumaImpu>();
            DteTipoBult = new HashSet<DteTipoBult>();
        }
        ...
        public string LoteDocu { get; set; }
        public string CodiServ { get; set; }
        public decimal? CorrCertFirm { get; set; }
        public string CodiForm { get; set; }
        public int? PeriPart { get; set; }
        public string EstaReme { get; set; }
        public string EvenRecl { get; set; }
        public string DocuEscd { get; set; }
        public decimal? TranVent { get; set; }
        public decimal? TranComp { get; set; }

        public virtual Empr CodiEmprNavigation { get; set; }
        public virtual DteEnviDocu CorrEnvi1Navigation { get; set; }
        ...
        public virtual ICollection<DteAcciDocu> DteAcciDocu { get; set; }
        public virtual ICollection<DteArchAdju> DteArchAdju { get; set; }
        public virtual ICollection<DteComiCarg> DteComiCarg { get; set; }
        public virtual ICollection<DteDescReca> DteDescReca { get; set; }
        public virtual ICollection<DteDetaAcec> DteDetaAcec { get; set; }
        public virtual ICollection<DteDetaPrse> DteDetaPrse { get; set; }
        public virtual ICollection<DteDocuLob> DteDocuLob { get; set; }
        public virtual ICollection<DteDocuRefe> DteDocuRefe { get; set; }
        public virtual ICollection<DteEnviPdf> DteEnviPdf { get; set; }
        public virtual ICollection<DteSumaImom> DteSumaImom { get; set; }
        public virtual ICollection<DteSumaImpu> DteSumaImpu { get; set; }
        public virtual ICollection<DteTipoBult> DteTipoBult { get; set; }
    }
}
